...
def get_args():
    parser = argparse.ArgumentParser('Shenhai RL arguments for DDPG')
    ...
    parser.add_argument('--info_dir', type=str, default='info/ddpg')
    parser.add_argument('--te_dir', type=str, default='te/ddpg')
...
def main():
    ...
    for i_epoch in range(args.epoch):
        ...
        # TODO: Rollout
        while not done:
            action = ddpg.select_action(torch.from_numpy(s).float())
